...
def generate_adj_pems08(path):
    distance_df_filename, num_of_vertices = path + "/datasets/raw_data/PEMS07/PEMS07.csv", 883
    ...
    with open(path + "/datasets/raw_data/PEMS07/adj_PEMS07.pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open(path + "/datasets/raw_data/PEMS07/adj_PEMS7_distance.pkl", "wb") as f:
