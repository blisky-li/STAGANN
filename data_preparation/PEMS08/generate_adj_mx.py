...
def generate_adj_pems08(path):
    distance_df_filename, num_of_vertices = path + "/datasets/raw_data/PEMS08/PEMS08.csv", 170
    ...
    with open(path + "/datasets/raw_data/PEMS08/adj_PEMS08.pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open(path + "/datasets/raw_data/PEMS08/adj_PEMS08_distance.pkl", "wb") as f:
