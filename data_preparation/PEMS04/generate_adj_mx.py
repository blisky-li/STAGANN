...
def generate_adj_pems08(path):
    distance_df_filename, num_of_vertices = path + "/datasets/raw_data/PEMS04/PEMS04.csv", 307
    ...
    with open(path + "/datasets/raw_data/PEMS04/adj_PEMS04.pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open(path + "/datasets/raw_data/PEMS04/adj_PEMS04_distance.pkl", "wb") as f:
