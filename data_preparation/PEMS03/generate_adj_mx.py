...
def generate_adj_pems08(path):
    distance_df_filename, num_of_vertices = path + "/datasets/raw_data/PEMS03/PEMS03.csv", 358
    ...
    with open(path + "/datasets/raw_data/PEMS03/adj_PEMS03.pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open(path + "/datasets/raw_data/PEMS03/adj_PEMS03_distance.pkl", "wb") as f:
