...
CFG.DATASET_LEN = 24
CFG.DATASET_NAME = "PEMS-BAY_{0}{1}_{2}".format(str(CFG.DATASET_TRAINRATIO), str(CFG.DATASET_VALRATIO), CFG.DATASET_LEN)
...
CFG.DATASET.TRANSFORM = "standard_transform" # OR standard_transform "min_max_transform"
...
# ================= optim ================= #
CFG.TRAIN = EasyDict()
CFG.TRAIN.LOSS = {'masked_mae': masked_mae,  "masked_binary": masked_binary}# dilate_loss"linear_mmd": linear_mmd   "mmd": mmd   "coral": coral   "rsd": rsd    "masked_binary": masked_binary
