...
from stkriging.archs import DualSTN
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "DualSTN"
CFG.MODEL.ARCH = DualSTN
...
CFG.MODEL.PARAM = {
    ...
    'TGN_param' : {
            'layer1': {'dims_TGN': [-1, 8], 'depth_TGN': 1},
            'layer2': {'dims_TGN': [8, 16], 'depth_TGN': 1},
            'layer3': {'dims_TGN': [16, 32], 'depth_TGN': 1},
        },
    "hidden_size" : 48,
    "length": 24,
